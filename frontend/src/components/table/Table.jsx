...
<div class="bg-gray-900 rounded-xl p-5 border border-gray-800 hover:border-primary transition-all group">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                <button class="p-2 hover:bg-gray-800 rounded-lg transition-colors" title="Editar">
                                    <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                </button>
                                <button class="p-2 hover:bg-red-900/20 rounded-lg transition-colors" title="Eliminar">
